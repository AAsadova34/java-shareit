...
class ItemRequestControllerTest {
    ...
    @NullAndEmptySource
    @ValueSource(strings = {" "})
    void addItemRequest_whenDescriptionIsEmpty_thenMethodArgumentNotValidExceptionThrow(String description) {
        long userId = 1L;
        ItemRequestInnerDto requestInner = new ItemRequestInnerDto(description);
        String exceptionMessage = "Description must not be empty";
    ...
    @SneakyThrows
    @Test
    void getItemRequestsFromOthers_whenFromIsNegative_thenConstraintViolationExceptionThrow() {
        long userId = 1L;
        String from = "-1";
        String size = "2";
        String exceptionMessage = "getItemRequestsFromOthers.from: must be greater than or equal to 0";
    ...
    void getItemRequestsFromOthers_whenSizeIsNegative_thenConstraintViolationExceptionThrow(String size) {
        long userId = 1L;
        String from = "0";
        String exceptionMessage = "getItemRequestsFromOthers.size: must be greater than 0";
